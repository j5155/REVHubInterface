...
class SetMotorChannelCurrentAlertLevel(REVPacket):
    ...
    def __init__(self):
        REVPacket.__init__(self, REVHeader(Cmd=MsgNum.SetMotorChannelCurrentAlertLevel),
...
class GetMotorChannelCurrentAlertLevel(REVPacket):
    ...
    def __init__(self):
        REVPacket.__init__(self, REVHeader(Cmd=MsgNum.GetMotorChannelCurrentAlertLevel),
...
class GetMotorChannelCurrentAlertLevel_RSP(REVPacket):
    ...
    def __init__(self):
        REVPacket.__init__(self, REVHeader(Cmd=RespNum.GetMotorChannelCurrentAlertLevel_RSP),
...
class GetMotorTargetVelocity_RSP(REVPacket):
    ...
    def __init__(self):
        REVPacket.__init__(self, REVHeader(Cmd=RespNum.GetMotorTargetVelocity_RSP),
...
class GetMotorTargetPosition_RSP(REVPacket):
    ...
    def __init__(self):
        REVPacket.__init__(self, REVHeader(Cmd=RespNum.GetMotorTargetPosition_RSP),
...
class GetMotorEncoderPosition_RSP(REVPacket):
    ...
    def __init__(self):
        REVPacket.__init__(self, REVHeader(Cmd=RespNum.GetMotorEncoderPosition_RSP),
...
class GetMotorPIDCoefficients_RSP(REVPacket):
    ...
    def __init__(self):
        REVPacket.__init__(self, REVHeader(Cmd=RespNum.GetMotorPIDCoefficients_RSP),
